...
SET REPO_NAME=predix-microservice-cf-jsr
SET SHELL_SCRIPT_NAME=quickstart-microservice-cf-jsr.sh
SET APP_DIR="microservice-template"
SET APP_NAME="microservice template jsr 311"
